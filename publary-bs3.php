                ...
                <ul class="dropdown-menu">
                    <?php
                        foreach($years as $year => $count)
                        {
                            ...
                            print '<li><a class="dropdown-item" href="#'.$year.'">'.$year.'</a></li>';
                        }
                    ?>
                    <li role="separator" class="divider dropdown-divider"></li>
                    <li><a class="dropdown-item" href="#diss">Dissertationen</a></li>
                </ul>
            </li>
            <li class="nav-item">
                    <a class="switch-list text-muted" href="#">
                        <span class="brief-list d-none"><i class="fas fa-bars"></i></span>
                        <span class="full-list"><i class="fas fa-align-justify"></i></span>
                    </a>
            </li>
            <li class="nav-item">
